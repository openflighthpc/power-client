# Contributing to Power Client

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Power Client? Welcome! Please read this
...
You can help Power Client by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/power-client/issues?state=open)
...
If you find a bug - behaviour of Power Client code or documentation
...
[GitHub issue tracker for Power Client](https://github.com/openflighthpc/power-client/issues/new)
to report the issue.
...
We want to improve the quality of Power Client and good bug reports are
...
Power Client is Open Source and comes without warranty.
...
Power Client in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Power Client and really improve it. The more
...
applied to Power Client itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/power-client). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Power Client developers also have their regular
